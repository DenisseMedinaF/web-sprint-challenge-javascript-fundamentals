...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
console.log('Topic 1 Closure Response:', 'The nested function above can access the variable internal because it is within the function, myFunction.')
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    const animalNamesArray = [];
    array.forEach(element => animalNamesArray.push(`name: ${element.animal_name}, scientific: ${element.scientific_name}`))
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCase = array.map(x => x.animal_name.toLowerCase());
    return lowerCase;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const filteredPopulation = array.filter(population => population.population < 5)
  ...
  */
  ...
  function USApop(array){
    const gatherTotalPopulation = array.map(x => x.population)
    const totalPopulation = gatherTotalPopulation.reduce((prevValue, currValue) => prevValue + currValue)
  ...
  */
  ...
  console.log('Callback Step One:', consume(1, 2, add));
...
function add(a, b){
  ...
  console.log('Step 2 (Add):', add(3, 2))  
  console.log('Step 2 (Add):', add(6, 5))
  console.log('Step 2 (Add):', add(7, 9))
...
function multiply(a, b){
  ...
  console.log('Step 2 (Multiply):', multiply(3, 7))
  console.log('Step 2 (Multiply):', multiply(2, 1))
  console.log('Step 2 (Multiply):', multiply(6, 6))
...
function greeting(firstName, lastName){
  ...
  console.log('Step 2 (Greeting):', greeting('BloomTech', 'Learner'))
  console.log('Step 2 (Greeting):', greeting('Adam', 'James'))
  console.log('Step 2 (Greeting):', greeting('Emily', 'Johnson'))
...
let cuboid = new CuboidMaker({length: 3, width: 2, height: 8});
...
console.log('Topic 3, Step 2:', cuboid.volume());
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker (not auto graded)🐴🐴🐴
  ...
  const cuboidObj = new CuboidMaker({length: 4, width: 5, height: 5});

console.log('Step 4', cuboidObj)
...
const cuboidTwo = new CuboidMakerTwo({length: 2, width: 2, height: 4});
